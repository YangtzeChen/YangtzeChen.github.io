...
采用日系 / 北欧风格设计，配合 [Sveltia CMS](https://github.com/sveltia/sveltia-cms) 实现浏览器端内容管理 —— 无需本地环境，直接在网页上发布文章和上传图片。

## ✨ 特性 (V2.1.0 500px 风格升级)
...
- 🔧 **Sveltia CMS 后台** — 现代化、所见即所得的极速发布工作流系统。原生的拖拽网格图库，智能 Git 防覆盖同步策略
